...
import { Play, RotateCw, Download, Terminal, AlertTriangle, Activity } from 'lucide-react';
  ...
  return (
    ...
    <div className="space-y-6 font-mono">
      ...
      <section
        ...
        aria-label="Analysis Execution Panel"

        className="p-6 rounded-2xl bg-[#0c162d]/90 border border-slate-800/80 backdrop-blur-md shadow-xl space-y-4"
      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 border-b border-slate-800/80 pb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-white uppercase tracking-wider">
              ...
              ANALYSIS PARAMETERS :: {tool.name.toUpperCase()}
          ...
          <span className="text-[11px] text-slate-400">
            ...
            Target Type: <strong className="text-cyan-400">{(tool.inputType || 'string').toUpperCase()}</strong>
        ...
        {/* Target Input & Action Bar */}

        <div className="space-y-2">

          <label htmlFor="analyzer-target-input" className="block text-xs text-slate-300 font-semibold tracking-wide">

            Target Domain, Hostname, URL, or Payload
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-3">
            ...
            <div className="flex-1 relative rounded-xl bg-[#071126] border border-slate-700/80 focus-within:border-cyan-500 focus-within:ring-2 focus-within:ring-cyan-500/20 transition-all flex items-center px-4 py-3">
              ...
              <input
                ...
                placeholder={tool.inputPlaceholder || 'Enter target string...'}
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl font-mono text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all ${
                ...
                analyzing || !target.trim()
                  ...
                  : 'bg-gradient-to-r from-cyan-500 to-emerald-500 hover:from-cyan-400 hover:to-emerald-400 text-[#020814] shadow-[0_0_20px_rgba(6,182,212,0.35)] cursor-pointer'
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-400 pt-1">
            ...
            <span>Press <kbd className="px-1.5 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-300">Enter</kbd> to execute analysis</span>

            <span className="text-slate-500">SSRF & Injection Filters Active</span>
      ...
      {/* Analyzing Pulse Status Bar */}

      {analyzing && (

        <div className="p-4 rounded-xl bg-[#0c162d]/60 border border-cyan-500/30 flex items-center justify-between gap-4 text-xs font-mono">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-cyan-400 font-bold">
              ...
              ANALYZER ACTIVE :: SYNTHESIZING {target.trim()}
      ...
      <section
        ...
        aria-label="Diagnostic Analysis Dossier"

        className="rounded-2xl border border-slate-800/80 bg-[#0c162d]/90 backdrop-blur-md p-6 shadow-2xl space-y-6"
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold text-white uppercase tracking-wider">
              ...
              {analyzing ? 'ANALYSIS IN PROGRESS...' : results ? 'DIAGNOSTIC ANALYSIS DOSSIER' : 'ANALYSIS DOSSIER'}
        ...
        {!analyzing && !results && !error && (
          ...
          <div className="h-44 flex flex-col items-center justify-center text-center text-slate-500 space-y-2">
            ...
            <p className="text-xs">
              ...
              Enter target above and click Execute Analysis to generate diagnostic report.

                ...
                >
                  ...
                  <div className="mt-8 pt-4 border-t border-white/10 text-center relative z-10 flex flex-col gap-2">
                    <p className="font-mono text-[10px] text-cyber-muted">
                      ...
                      <Link to={`/signup?returnTo=${encodeURIComponent(returnTo || '')}`} className="text-cyber-green hover:underline decoration-cyber-green/50 underline-offset-4">{t('auth.login.register')} →</Link>
                    </p>
                  </div>
                </motion.div>
              )}

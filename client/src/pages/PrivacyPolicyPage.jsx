...
const sections = [
  ...
  },
  {
    ...
    icon: '🌐',
    items: [
      { label: 'UrlEngine', value: 'Threat intelligence scanning — submitted targets are sent to their API' },
      { label: 'UrlEngine', value: 'IP reputation — submitted IPs are checked against their database' },
      ...
      { label: 'CIRCL UrlEngine', value: 'File hash reputation — hash values are sent to CIRCL\'s public API' },
    ],
